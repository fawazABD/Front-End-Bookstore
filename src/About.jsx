  ...
  return (
    <div>
        ...
        >
          <div className="flex flex-col justify-center items-center text-center mt-40">
            ...
            <div className="flex flex-row">
              ...
              <h4 className="text-2xl font-semibold"><Link to="/about">about</Link></h4>
            </div>
          </div>
        </div>
      </div>
      <div className="flex justify-center items-center w-[82%] m-auto">
        <div>
          <img height="100%" width="100%" className="h-[350px] w-[800px]"src="https://allisonjpmiller.com/wp-content/uploads/2015/04/bookpath.png?w=1200&h=900&crop=1" alt="" />
        </div>
        <div className="container bg-slate-400 p-4 text-black leading-[2rem]">
          <h1 className="text-2xl font-bold">WHY YOU CHOOSE US?</h1>
          <p className="w-[80%]">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Obcaecati pariatur hic, dicta error magnam libero perspiciatis quos exercitationem, eaque a necessitatibus. Voluptate dignissimos excepturi, nam animi recusandae illum expedita, molestiae commodi praesentium quas fugit perferendis! Cum nam iste veniam veritatis!</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3  mt-6 mb-5 items-center ml-32">
        <div className="container mx-auto my-8">
          ...
          <div>
            <img width="100%" height="100%" className="rounded-full w-[55px] h-[55px]" src="https://niksessentialoils.com/wp-content/uploads/2021/06/av4-300x225.jpg" alt="" />
            </div>
        ...
        <div className="container mx-auto my-8">
          <div className="bg-white h-72 w-72 shadow-lg border border-black p-7 rounded-md flex flex-col items-center">
            <div>
                <img width="100%" height="100%" className="rounded-full w-[55px] h-[55px]" src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcTjt4Deh15rOR9m98Ty8onKUTBeNHxNsOjwsrhO2C8W7IDxM_1y" alt="" />
            </div>
        ...
        <div className="container mx-auto my-8">
          <div className="bg-white h-72 w-72 shadow-lg border border-black p-7 rounded-md flex flex-col items-center">
            <div>
                <img width="100%" height="100%" className="rounded-full w-[55px] h-[55px]" src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcS4CKVjnHlhFhnqZi3xNmcABSmQbm36__dj4l6__Sw5Bh_7NKUl" alt="" />
            </div>
        ...
        <div className="container mx-auto my-8">
          <div className="bg-white h-72 w-72 shadow-lg border border-black p-7 rounded-md flex flex-col items-center">
            <div>
                <img width="100%" height="100%" className="rounded-full w-[55px] h-[55px]" src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTjmRikUR5KOSzaDmFXD6GWwTAuQWmICwFDtZ2zOg7FE4MTyvfw" alt="" />
            </div>
        ...
        <div className="container mx-auto my-8">
          <div className="bg-white h-72 w-72 shadow-lg border border-black p-7 rounded-md flex flex-col items-center">
            <div>
                <img width="100%" height="100%" className="rounded-full w-[55px] h-[55px]"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQKsF0ji4VtMxIaH_PHkqv3YfrHDsylIJT0nzIOKE00LmPjaZv" alt="" />
            </div>
        ...
        <div className="container mx-auto my-8">
          <div className="bg-white h-72 w-72 shadow-lg border border-black p-7 rounded-md flex flex-col items-center">
            <div>
                <img width="100%" height="100%" className="rounded-full w-[55px] h-[55px]"   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS43VxCopuMVYcGwA5wZKWGiRN_b-QIysmw93oG3ggXvOkATyT7" alt="" />
            </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4  mt-6 mb-5 items-center ml-32">
          ...
          <div>
            <div
              className="bg-no-repeat bg-cover h-80 w-72 border ove border-black "
              style={{ backgroundImage: `url(${author_5_bg})` }}
            >
              <div className="ml-2 text-2xl absolute left-[30px]">
                <div className=" bg-white h-7 w-7 items-center text-center border border-black mb-2 mt-3 ">
                  <FaFacebookF />
                </div>
                <div className=" bg-white h-7 w-7 items-center text-center border border-black mb-2">
